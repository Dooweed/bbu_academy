...
class SmallPurchaseRecord(PaymeMerchantMixin):
    ...
    service = models.ForeignKey(verbose_name='Услуга', to='services.Service', on_delete=models.RESTRICT, null=True, blank=True)
    ...
    amount = models.IntegerField('Кол-во наименований товара', null=True, blank=True)
