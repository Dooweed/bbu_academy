...
class BasePaymentInitialisationForm(forms.Form):
    ...
    def __init__(self, purchase_id, phone, amount, lang, *args, **kwargs):
...
class ButtonBasePaymentInitialisationForm(BasePaymentInitialisationForm):
    ...
    def __init__(self, purchase_id, phone, amount, lang, type="svg", style="colored", width=200, *args, **kwargs):
        # Check type argument
        ...
        super().__init__(purchase_id, phone, amount, lang, *args, **kwargs)
...
class QrBasePaymentInitialisationForm(BasePaymentInitialisationForm):
    ...
    def __init__(self, purchase_id, phone, amount, lang, size=250, *args, **kwargs):
        # Check width argument
